...
/**
 * The standalone mod's packet channel. The ids below are wire format: never renumber one, never reuse a
 * retired one. The API jar has its own separate channel ({@code customglint_api:main}) for entity sync.
 */
